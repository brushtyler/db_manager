...
#
# Created: Mon Feb 27 14:29:12 2012
...
class Ui_DlgSqlWindow(object):
    def setupUi(self, DlgSqlWindow):
        ...
        DlgSqlWindow.resize(738, 525)
        self.gridLayout_2 = QtGui.QGridLayout(DlgSqlWindow)
        self.gridLayout_2.setObjectName(_fromUtf8("gridLayout_2"))
        self.splitter = QtGui.QSplitter(DlgSqlWindow)
        ...
        self.editSql = CompletionTextEdit(self.widget)
        ...
        self.btnClear = QtGui.QPushButton(self.widget)
        ...
        self.viewResult = QtGui.QTableView(self.widget1)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
...
"columns", None, QtGui.QApplication.UnicodeUTF8))
        self.label_5.setText(QtGui.QApplication.translate("DlgSqlWindow", "Layer name (prefix)", None, QtGui.QApplication.UnicodeUTF8))
        self.label_6.setText(QtGui.QApplication.translate("DlgSqlWindow", "Type", None, QtGui.QApplication.UnicodeUTF8))
        self.vectorRadio.setText(QtGui.QApplication.translate("DlgSqlWindow", "Vector", None, QtGui.QApplication.UnicodeUTF8))
        self.rasterRadio.setText(QtGui.QApplication.translate("DlgSqlWindow", "Raster", None, QtGui.QApplication.UnicodeUTF8))
        self.loadLayerBtn.setText(QtGui.QApplication.translate("DlgSqlWindow", "Load now!", None, QtGui.QApplication.UnicodeUTF8))
