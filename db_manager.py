...
class DBManager(QMainWindow):
	...
	def refreshTabs(self):
		...
		self.tabs.setTabEnabled( self.tabs.indexOf(self.preview), table != None and (table.type == Table.VectorType or table.type == Table.RasterType) and table.geomColumn != None )
